...
function resolve_build_context() {
  ...
  ROOTFS_BUILD_LOG_NAME="${ROOTFS_NAME_PREFIX}-${ARTIFACT_VERSION_TAG}.build.log"
  ...
  IMAGE_BUILD_LOG_NAME="${RESOLVED_IMAGE_NAME_PREFIX}-${ARTIFACT_VERSION_TAG}.build.log"
  BUILD_LOG_NAME="${IMAGE_BUILD_LOG_NAME}"
  ROOTFS_ARTIFACT_PATH="${ROOTFS_OUTPUT_DIR}/${ROOTFS_ARTIFACT_NAME}"
  ROOTFS_MANIFEST_PATH="${ROOTFS_OUTPUT_DIR}/${ROOTFS_MANIFEST_NAME}"
  ROOTFS_BUILD_LOG_PATH="${ROOTFS_OUTPUT_DIR}/${ROOTFS_BUILD_LOG_NAME}"
  ...
  IMAGE_BUILD_LOG_PATH="${IMAGE_OUTPUT_DIR}/${IMAGE_BUILD_LOG_NAME}"
  BUILD_LOG_PATH="${IMAGE_BUILD_LOG_PATH}"
  ...
  export ROOTFS_BUILD_LOG_NAME
  export ROOTFS_ARTIFACT_PATH
  export ROOTFS_MANIFEST_PATH
  export ROOTFS_BUILD_LOG_PATH
  ...
  export IMAGE_BUILD_LOG_NAME
  export IMAGE_BUILD_LOG_PATH
